    ...
    <section className="bg-white py-20 lg:py-24 px-6 lg:px-16 flex flex-col lg:flex-row items-center justify-between">
      <div className="w-full lg:w-1/2 space-y-8 text-center lg:text-left">
        <div className="flex items-center justify-center lg:justify-start gap-4">
          <Sparkles className="text-orange-600 w-12 h-12" />
          <h1 className="text-4xl lg:text-5xl font-bold text-orange-600 font-poppins">
            BreadTalk's Magic
          </h1>
        </div>
        ...
        <div className="flex justify-center lg:justify-start">
          <button className="group flex items-center gap-3 bg-orange-600 hover:bg-orange-700 text-white px-10 py-4 rounded-xl text-lg font-semibold transition-all transform hover:scale-105 hover:shadow-lg">
      ...
      <div className="hidden lg:block w-1/2 pl-16 mt-8 lg:mt-0">
        <div className="relative w-full max-w-[500px] aspect-square mx-auto">
          <div className="absolute inset-0 bg-orange-100 rounded-full animate-blob opacity-50 mix-blend-multiply filter blur-2xl"></div>
